...
ActiveRecord::Schema.define(version: 20160211070108) do
  ...
  create_table "article_assignments", force: true do |t|
  ...
  add_index "article_assignments", ["article_id"], name: "index_article_assignments_on_article_id", using: :btree
  add_index "article_assignments", ["assignment_id"], name: "index_article_assignments_on_assignment_id", using: :btree
